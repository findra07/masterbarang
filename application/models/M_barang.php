...
class M_barang extends CI_Model
{
	...
	public function lihat_foto($kode_barang)
	{
		$query = $this->db->get_where($this->_table, ['kode_barang' => $kode_barang]);
		return $query->row();
	}
	...
	public function tambah($baru)
	{
		return $this->db->insert($this->_table, $baru);
	}
	...
	public function ubah_foto($data, $kode_barang)
	{
		$query = $this->db->set('foto', $data);
		$query = $this->db->where(['kode_barang' => $kode_barang]);
		$query = $this->db->update($this->_table);
		return $query;
	}
