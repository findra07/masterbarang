								...
								<div class="card-body">
									<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
										<div class="form-row">
											...
											<!-- <div class="form-group col-md-2">
												<label for="kode_barang"><strong>Kode Barang</strong></label>
												<input type="text" name="kode_barang" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control" required value="<?= $unik ?>" maxlength="8" readonly>
											</div> -->
										...
										<div class="form-row">
											...
											<div class="form-group col-md-5">
												<label for="img_barang"><strong>Gambar</strong></label>
												<input type="file" id="img_barang" name="img_barang" autocomplete="off" class="form-control" required>
											</div>
										</div>
										<hr>
